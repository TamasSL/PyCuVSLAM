...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in sensor_stream_pb2_grpc.py depends on'
...
def add_SensorStreamServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'sensor_stream.SensorStreamService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('sensor_stream.SensorStreamService', rpc_method_handlers)
