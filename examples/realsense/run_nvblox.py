...
async def main() -> None:
    ...
    vis_subscriber = VisualizerSubscriber(slam_publisher, "VisualizerSubscriber")
    ...
    try:
        while True:
            ...
            if frame_id > WARMUP_FRAMES:
                ...
                yaw, roll, pitch = quaternion_to_euler(quaternion[0], quaternion[1], quaternion[2], quaternion[3])
                ...
                vis_subscriber.publish(publish_data)
